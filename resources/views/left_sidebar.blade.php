    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div class="scroll-sidebar" style="overflow: hidden; width: auto; height: 100%;">
            ...
            <nav class="sidebar-nav active">
                <ul id="sidebarnav" class="in">
                    ...
                    <li class="nav-label">Membres</li>
                    <li >
                        <a class="" href="{{ route('membre.index') }}">
                    ...
                    <li >
                        <a class="" href="{{ route('typeMembre.index') }}">
                            <i class="fa fa-users"></i>
                            <span class="hide-menu">
                                Types de Membres
                            </span>
        ...
        </div><div class="slimScrollBar" style="background: rgb(220, 220, 220); width: 5px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; left: 1px; height: 952px;"></div><div class="slimScrollRail" style="width: 5px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; left: 1px;"></div></div>
    <!-- End Sidebar scroll-->
</div>